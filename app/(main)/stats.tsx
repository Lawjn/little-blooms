    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        ...
        {entriesQuery.isLoading ? (
          ...
          <>
            {/* Gợi ý trò chuyện với AI Coach */}
            <View style={styles.aiCard}>
              <View style={styles.aiHeader}>
                <MaterialCommunityIcons name="sprout" size={20} color="#7E57C2" />
                <Text style={styles.aiTitle}>Trò chuyện cùng Bloom</Text>
              </View>
              <Text style={styles.aiText}>
                Mở Bloom ở màn hình Home (biểu tượng 💬) để được phân tích cảm xúc và nhận
                lời khuyên điều chỉnh lối sống dựa trên nhật ký của bạn. 🌱
              </Text>
            </View>
